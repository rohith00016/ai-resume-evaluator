...
import { uploadResume, clearError } from "../features/resumeSlice";
import {
  Upload,
  User,
  Mail,
...
const LearnerForm = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.prompt.trim()) {
      errors.prompt = "Evaluation prompt is required";
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Describe the role or criteria for evaluation (e.g., 'Evaluate for software engineer position with focus on technical skills')"
              />
